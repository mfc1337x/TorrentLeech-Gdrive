...
async def help_message_f(client, message):
    ...
    await message.reply_text("""Kya he bhosdike? Call @iclapcheeks for help otherwise jake apni gand marale!
    First sand link then reply with one of the below commands.
